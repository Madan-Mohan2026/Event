/**
 * Centralized Event & Registration Status Calculation Utility (Backend TS)
 ...
 */
export function getEventStatus(event: any, nowInput?: Date | string | number): 'upcoming' | 'ongoing' | 'completed' {
 ...
 */
export function getRegistrationStatus(event: any, nowInput?: Date | string | number): RegistrationStatusConfig {
  const now = nowInput ? new Date(nowInput) : new Date();
 ...
 */
export function isRegistrationAllowed(event: any, nowInput?: Date | string | number): boolean {
